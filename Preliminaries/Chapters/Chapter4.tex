...
The figure below shows some images of the heart­-shaped primitive obtained from running the script above.
...
used   the   ImageMagick   convert   command   to   composite   them   into   a   single  
