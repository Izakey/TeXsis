...
invoked   with   no   arguments.   The   -­s   option   invokes   the   primitive   edit   mode   on   a  
...
database   database   destined   to   hold   the   \textit{amour}   object,   we   type   “in   amour   hrt   0  
