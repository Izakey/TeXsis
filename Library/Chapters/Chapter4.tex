...
In   this   chapter,   we   present   and   discuss   the   results   obtained   from   our  
...
BRL-­CAD's \textbf{\textit{in}} [37] command to test its mettle.  
...
describe   the   heart-­shaped   primitive,   we   used   BRL-­CAD's   \textit{\textbf{l}} [38]   command   on  
...
BRL­-CAD's \textit{\textbf{bb}} [39] command.
...
primitive   is   working,   we   use   the   \textit{\textbf{draw}} [40]   command   in   BRL­-CAD.   The   \textit{\textbf{draw}}  
...
works, we use BRL-­CAD's \textit{\textbf{rt}} [41] command. The \textit{\textbf{rt}} command ray­traces a set
...
pixels   respectively. To   do   this,   we   edited   the   Fly­Around   Animation   script   [42]  
...
these   can   be   viewed   on   my   youtube   channel [43] [44] .These   animations   are   proof   that  
