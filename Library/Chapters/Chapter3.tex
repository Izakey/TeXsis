...
This chapter states the aim of   contributing   to   the BRL-­CAD project  
...
\hspace{30} Depending   on   how it is termed, \textit{Free/Libre/Open   Source  
...
According   to   Eric   S.   Raymond [33],   one   of   the   most   prominent   evangelists   of  
...
using   free   software   with   thousands   of   projects   hosted   on   Sourceforge [34]   and  
Github [35].   It   has   singularly   developed   some   software   packages   and   tools  
...
Government   for   the   modeling   of   military   artillery   and   simulating   combat  vehicle   systems   and   environments.   This  limits   its   user   base   to  the   military   sector   and   repels   users   who  would have used it for more entertainment purposes.
\end{itemize}
...
\hspace{30} Now, we explain how the written functions actually compute each of these properties.
 Each   property   was   tested   using   BRL-­CAD's   commands [36]   after  having   
...
If   there   are   no  real   solutions,   then   the   ray   does   not   intersect   the   heart's   surface. The   coordinates   of   the   intersection   points were determined  by   substituting   the   values   for   real $t_i$ in (3) above.  
...
\hspace{30} Once   the   coefficients   of   (3)   are   determined,   it   is   parsed   through  
