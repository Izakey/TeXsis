...
In   a   bid   to contribute to BRL-CAD, we developed develop   a   heart-­shaped   primitive.   In   the   following   section,   we  
...
\textit{rt\_hrt\_bbox()}   function   which   had   two   three­-dimensional   points   as  
...
find the roots of polynomials.   Extensive   empirical   studies   show   that   this   method   has   come  
