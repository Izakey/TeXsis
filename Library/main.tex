...
\usepackage[square, graphicx, numbers, url, comma, sort&compress, tocloft, cite]{natbib}
...
%	CERTIFICATION PAGE
%----------------------------------------------------------------------------------------
%\newgeometry{a4paper,lmargin=2.0in,rmargin=0in,tmargin=1.4in,bmargin=0in}
\newgeometry{a4paper,lmargin=0.9in,rmargin=0.5in,tmargin=0.8in,bmargin=-1.0in}
\begin{figure}[htbp]
\centering
%\includegraphics[width=\textwidth, height=\textheight]{Figures/certification.jpg}
