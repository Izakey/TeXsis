...
\usepackage[a4paper,lmargin=3.5cm,right=1in,top=1in,bottom=1in,showframe]{geometry}
...
\end{flushright}
\end{minipage}
\Large \hspace{95} Nkweteyim L. Denis (PhD) \hspace{100} Kamgnia Emmanuel (PhD)\\
\large\hspace*{2em} (Head of Department) \hspace{180} (Supervisor)\\[1.0cm]
...
\end{flushright}
\end{minipage}
\hspace*{20em}Prof. Ayonghe N. Samuel\\ 
\hspace*{24em}( Dean )
}
\clearpage % Start a new page
