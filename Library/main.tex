...
\begin{minipage}{0.5\textwidth}
\begin{flushright}
\large\textbf{DEPARTMENT OF COMPUTER}\\ \large \hspace*{290} \textbf{SCIENCE} 
\end{flushright}
\end{minipage}
...
\Large \rule[1em]{11em}{2.0pt} \hspace{95} \Large \rule[1em]{11em}{2.0pt} \\ % This prints a line for the signature
\Large Nkweteyim L. Denis (PhD) \hspace{75} Kamgnia Emmanuel (PhD)\\
