...
\Large \textbf{BRL-CAD :} \hspace{10}Ballistic Research Laboratory Computer Aided Design \\
\Large \textbf{CSG :} \hspace{40} Constructive Solid Geometry \\
\Large \textbf{NURBS :} \hspace{20} Non-Uniform Rational B-Splines \\
\Large \textbf{NMG :} \hspace{36} Non - Manifold Geometry \\
\Large \textbf{B-REPS :} \hspace{20} Boundary Representations \\
}
\clearpage % Start a new page
