...
\Large \rule[1em]{11em}{2.0pt} \hspace{70} \Large \rule[1em]{11em}{2.0pt} \\ % This prints a line for the signature
\Large Nkweteyim L. Denis (PhD) \hspace{50} Kamgnia Emmanuel (PhD)\\
\large\hspace*{2em} (Head of Department) \hspace{135} (Supervisor)\\[1.0cm]

\Large This thesis has been accepted by the Faculty of Science.\\[0.5cm]

\Large \textbf{Date:}\\
\Large \hspace*{3em}\rule[1em]{10em}{2.0pt} \hspace{85} \Large \rule[1em]{10em}{2.0pt} \\ % This prints a line for the signature
