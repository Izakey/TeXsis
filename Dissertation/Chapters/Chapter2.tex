...
over the field of coefficients $\mathbb{F}$. In \cite{9}, Lazard constructed a Gr\"\o bner basis with  
...
Although Gr\"\o bner basis methods are more efficient and effective than
